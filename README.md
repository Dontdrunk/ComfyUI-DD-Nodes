...
- 内置智能模式（针对模型大小与电脑配置自动选择最佳加载方案）（对24G或24G显存以上的显卡没有任何优化效果，显卡越差 优化越好）
- 完整的加载进度显示
...
![QQ20250301-192720](https://github.com/user-attachments/assets/1898f2cb-6c8d-4199-b117-db66102a7b13)
