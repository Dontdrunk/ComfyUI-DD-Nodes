...
| **DD 节点连线动画** | 为 ComfyUI 节点连线提供多种炫酷动画效果，支持"流动"、"波浪"、"律动"、"脉冲"等动画风格。支持5种渲染样式（直线、直角线、曲线、电路板1、电路板2），动画参数可自定义（线宽、速度、特效等）。提供"全部显示"和"悬停节点"两种显示模式，悬停模式下采用静态+动画叠加的混合渲染技术，大幅优化性能表现 | ![连线动画效果](https://github.com/user-attachments/assets/aeac1b96-c8d0-497a-9594-1ab7b5766f44) |
...
| **DD Qwen-MT翻译** | 强大的多语言翻译节点，基于阿里云通义千问翻译服务。支持80+种语言互译，提供通用翻译、术语翻译、领域翻译三种模式。内置智能API配置界面，支持缓存优化，为多语言工作流提供专业翻译支持 | ![Qwen-MT翻译界面](https://github.com/user-attachments/assets/placeholder-qwen-mt-image) |
